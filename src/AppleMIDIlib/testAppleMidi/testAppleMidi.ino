...
char ssid[] = "ONO415534"; //  your network SSID (name)
char pass[] = "HPUCSNJR";    // your network password (use for WPA, or use as key for WEP)
...
void onReceiveClockTick() {
    //Serial.println("TICK!");
}

void onReceiveClockStart() {
    Serial.println("START!");
}

void onReceiveClockContinue() {
    Serial.println("CONTINUE!");
}

void onReceiveClockStop() {
    Serial.println("STOP!");
}
...
void setup()
{
  ...
  AppleMIDI.OnReceiveClock(onReceiveClockTick);
  AppleMIDI.OnReceiveStart(onReceiveClockStart);
  AppleMIDI.OnReceiveContinue(onReceiveClockContinue);
  AppleMIDI.OnReceiveStop(onReceiveClockStop);
